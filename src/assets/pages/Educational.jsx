...
function Form2() {
  return (
    <div className="w-full max-w-3xl bg-white p-8 rounded-lg">
      ...
      <div className="bg-[#E9EAF4] p-6 rounded-lg mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input type="text" className="w-full p-2 border border-gray-300 rounded bg-[#FFFFFF]" placeholder="Enter name" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Date of issue</label>
            <input type="date" className="w-full p-2 border border-gray-300 rounded bg-[#FFFFFF]" />
          </div>
          <div className="col-span-1 md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-1">Description</label>
            <input type="text" className="w-full p-2 border border-gray-300 rounded bg-[#FFFFFF]" placeholder="Enter text" />
          </div>
        </div>
      ...
      <button className="text-blue-500 mb-6">+ Add Another Certificate</button>
